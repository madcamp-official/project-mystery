...
namespace Wake.Narrative
{
    ...
    public static class AmbientBarkCatalog
    {
        ...
        private static readonly AmbientBarkRecord[] BaselineEntries =
        {
            ...
            B("BALLROOM_ATTENDANT", "CREW_ATTENDANT_BALLROOM",
            ...
            B("ATRIUM_PHOTOGRAPHER", "PASSENGER_ATRIUM",
            ...
            B("ATRIUM_MEDBAY_RUMOR", "PASSENGER_ATRIUM",
                "파티가 끝나기도 전에 의무실로 사람이 실려 갔다더군요.",
                "whisper", "chapter=2", "ATRIUM"),
            B("ATRIUM_PHOTOGRAPHER_MID", "PASSENGER_ATRIUM",
            ...
            B("NEWS_REPORTER", "PASSENGER_NEWS",
            ...
            B("VAULT_SECURITY_MID", "CREW_SECURITY_VAULT",
                "이중 인증 기록을 매일 보안실로 넘기고 있습니다. 예전엔 주간 단위였습니다.",
                "firm", "chapter>=2 and chapter<=4", "VAULT"),
            B("VAULT_SECURITY_LATE", "CREW_SECURITY_VAULT",
