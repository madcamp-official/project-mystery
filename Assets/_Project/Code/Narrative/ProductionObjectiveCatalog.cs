...
namespace Wake.Narrative
{
    ...
    public static class ProductionObjectiveCatalog
    {
        private static readonly string[,] SourceText =
        {
            ...
            { "P-02", "승선 명단의 오류", "Daniel의 초대가 Richard 명의임을 확인한다." },
            ...
            { "D1-05", "수상한 호출", "Evelyn이 Richard에게 Daniel의 대기 사실을 알린 정황을 확인한다." },
            { "D1-06", "흔적 없는 밀실", "Horizon Room의 시신과 사용되지 않은 출구를 확인한다." },
            ...
            { "D3-05", "익명 제보자의 문장", "Daniel의 채팅에서 반복되는 어휘를 찾는다." },
            ...
            { "D6-03", "검은 바닥", "Daniel 구두의 고무 조각과 바닥을 대조한다." },
            { "D6-04", "두 번의 죽음", "자상은 비치명상이고 직접 사인은 질식임을 확정한다." },
            { "D6-05", "타임라인 퍼즐", "21:22부터 22:45까지 사건의 참 타임라인을 완성한다." },
            { "D7-01", "마지막 파괴 시도", "Evelyn이 모듈을 파괴하려는 것을 저지한다." },
            { "D7-02", "보호면의 침방울", "Evelyn의 장비와 Daniel의 DNA를 연결한다." },
            { "D7-03", "Orpheus 원본 음성", "복원된 기록에서 Julian과 Evelyn의 대화를 확인한다." },
            { "D7-04", "Evelyn의 제안", "Richard를 희생양으로 삼으려는 거래 제안을 심문한다." },
            { "D8-01", "흔적 없는 밀실의 해답", "Daniel의 시신만 Horizon Room에 들어온 수법을 논증한다." },
            { "D8-02", "Evelyn의 책임", "Orpheus와 Daniel 사건에 대한 Evelyn의 책임을 추궁한다." },
