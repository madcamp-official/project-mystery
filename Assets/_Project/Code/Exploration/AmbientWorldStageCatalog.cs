...
namespace Wake.Exploration
{
    ...
    public static class AmbientWorldStageCatalog
    {
        ...
        private static readonly AmbientWorldStageRecord[] Entries =
        {
            ...
            S("OPEN_DECK", "PASSENGER_DECK", .25f, .035f, .59f, false,
                Daylight, .020f, -.008f, .25f, .64f),
            S("OPEN_DECK", "CREW_SECURITY_DECK", .74f, .035f, .60f, true,
            ...
            S("BALLROOM", "CREW_ATTENDANT_BALLROOM", .73f, .035f, .58f, true,
                LuxuryInterior, -.016f, -.010f, .34f, .62f),
            ...
            S("PROMENADE", "PASSENGER_PROMENADE_2", .58f, .035f, .51f, false,
                Daylight, -.018f, -.008f, .26f, .55f),
            S("PROMENADE", "PASSENGER_PROMENADE", .79f, .035f, .54f, true,
            ...
            S("ATRIUM", "PASSENGER_ATRIUM", .25f, .035f, .57f, false,
            ...
            S("NEWS_LOUNGE", "PASSENGER_NEWS", .50f, .035f, .54f, false,
            ...
            S("BALLAST_TANKS", "BALLAST_CONTROLLER_TANKS", .58f, .035f, .51f, true,
                CoolMachinery, -.018f, -.010f, .48f, .58f),
            S("GENERATOR", "CREW_ENGINEER_GENERATOR", .78f, .035f, .54f, true,
