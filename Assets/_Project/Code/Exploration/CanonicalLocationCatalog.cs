...
namespace Wake.Exploration
{
    ...
    public static class CanonicalLocationCatalog
    {
        ...
        private static readonly CanonicalLocationSpec[] Definitions =
        {
            ...
            L("VIP_LOUNGE", "귀빈 라운지", 10, "D10-2", "bg_location_d10_2_vip_lounge.png", "CABIN_CLAIRE"),
            L("OPEN_DECK", "야외 갑판", 10, "D10-3", "bg_location_d10_3_open_deck.png", "STERN"),
            ...
            L("NEWS_LOUNGE", "뉴스 라운지", 8, "D8-2", "bg_location_d8_2_news_lounge_evidence.png", "CABIN_DANIEL", "EVIDENCE_BOARD"),
            L("SECURITY", "보안실", 8, "D8-3", "bg_location_d8_3_security_evidence.png", "INTERVIEW"),
            L("SERVICE_RAIL", "서비스 레일", 8, "D8-4", "bg_location_d8_4_service_rail.png"),
            L("MEDBAY", "의무실", 7, "D7-1", "bg_location_d7_1_medbay_evidence.png", "FORENSIC"),
            L("BALLAST_CONTROL_ANNEX", "밸러스트 제어 별실", 7, "D7-2", "bg_location_d7_2_ballast_control_annex_evidence.png", "BALLAST"),
            L("ENGINE_CONTROL", "기관 제어실", 7, "D7-3", "bg_location_d7_3_engine_control_evidence.png", "ENGINE_CTRL", "BRIDGE"),
            L("CREW_STAIRS", "승무원 계단", 7, "D7-4", "bg_location_d7_4_crew_stairs.png", "STAIR_B", "SERVICE7"),
            L("VAULT", "금고실", 6, "D6-1", "bg_location_d6_1_vault.png"),
            L("ARCHIVE", "기록 보관실", 6, "D6-2", "bg_location_d6_2_archive.png"),
            L("LAUNDRY", "세탁실", 6, "D6-3", "bg_location_d6_3_laundry.png"),
            L("SERVICE_HUB", "서비스 허브", 6, "D6-4", "bg_location_d6_4_service_hub.png"),
            L("STABILIZERS", "안정기실", 5, "D5-1", "bg_location_d5_1_stabilizers.png"),
            L("BALLAST_TANKS", "밸러스트 탱크", 5, "D5-2", "bg_location_d5_2_ballast_tanks.png"),
            L("GENERATOR", "발전기실", 5, "D5-3", "bg_location_d5_3_generator.png"),
            L("WORKSHOP", "작업실", 5, "D5-4", "bg_location_d5_4_workshop.png")
        };
