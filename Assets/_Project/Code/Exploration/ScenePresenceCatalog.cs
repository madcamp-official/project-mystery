...
namespace Wake.Exploration
{
    ...
    public static class ScenePresenceCatalog
    {
        ...
        private static readonly ScenePresenceRecord[] Entries =
        {
            ...
            S("D1-04", "SERVICE7", "SCENE_D104_STAIRS", "CREW_ATTENDANT", "SERVICE7", "SERVICE7", "RICHARD_SUITE", "VIP_LOUNGE", "VIP_LOUNGE", "ENGINE_CONTROL", "SECURITY", "MEDBAY", "ENGINE_CONTROL"),
            ...
            S("D2-06", "CABIN_DANIEL", "SCENE_D206_NEWS", "PASSENGER_D", "CABIN_DANIEL", "MEDBAY", "RICHARD_SUITE", "VIP_LOUNGE", "NEWS_LOUNGE", "ENGINE_CONTROL", "SECURITY", "MEDBAY", "ENGINE_CONTROL"),
            ...
            S("D3-03", "BRIDGE", "SCENE_D303_ENGINE", "CHIEF_ENGINEER", "BRIDGE", "MEDBAY", "RICHARD_SUITE", "VIP_LOUNGE", "VIP_LOUNGE", "BRIDGE", "SECURITY", "MEDBAY", "BRIDGE"),
            ...
            S("D5-01", "CABIN_CLAIRE", "SCENE_D501_VIP", "VIP_HOST", "CABIN_CLAIRE", "MEDBAY", "RICHARD_SUITE", "VIP_LOUNGE", "CABIN_CLAIRE", "ENGINE_CONTROL", "MEDBAY", "MEDBAY", "ENGINE_CONTROL"),
            S("D5-02", "CABIN_CLAIRE", "SCENE_D502_VIP", "ROBOTICS_TECH", "CABIN_CLAIRE", "MEDBAY", "RICHARD_SUITE", "VIP_LOUNGE", "CABIN_CLAIRE", "ENGINE_CONTROL", "MEDBAY", "MEDBAY", "ENGINE_CONTROL"),
            S("D5-03", "INTERVIEW", "SCENE_D503_SECURITY", "SECURITY_OPERATOR", "INTERVIEW", "MEDBAY", "RICHARD_SUITE", "VIP_LOUNGE", "INTERVIEW", "ENGINE_CONTROL", "MEDBAY", "MEDBAY", "ENGINE_CONTROL"),
